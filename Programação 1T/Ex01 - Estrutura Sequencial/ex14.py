...
pesoPeixes = float(input('Digite o peso total dos peixes pescados:'))

if pesoPeixes > 50:
    excesso = pesoPeixes - 50
    multa = excesso*4
    print(f'Você tem {excesso:.1f} quilos de peixe em excesso.')
    print(f'Você receberá uma multa de R${multa:.2f}.')
else:
    print('Tudo certo! Você não pagará multa por quilo de peixe excedente.')
